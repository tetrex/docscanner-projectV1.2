// import 'package:doc_scanner/Widgets/NavBar/ButtonHandWriting.dart';
import 'package:doc_scanner/Widgets/NavBar/showRevealImageDialog.dart';
import 'package:flutter/material.dart';

class HandWrittenButton extends StatefulWidget {
  const HandWrittenButton({Key? key}) : super(key: key);

  @override
  _ButtonMainState createState() => _ButtonMainState();
}

class _ButtonMainState extends State<HandWrittenButton> {
  @override
